    ...
    <Fragment>
        ...
        <div className="container h-100">
          <div className="row h-100 align-items-center">
            <div className="col-md-12 text-center">
              <h1><strong>Welcome to Meerut Bus Travels</strong></h1>
              <p>
        ...
        <div className="container text-center">
          ...
          <div className="container">
            ...
            <div className="col-md-12">
              <p>https://www.facebook.com/meerutbus</p>

              <p>https://www.instagram.com/meerutbus</p>

              <p>https://www.google.com/meerutbus</p>

              <p>https://www.twitter.com/meerutbus</p>
      ...
      <section className="footer bg-dark">
        <div className="container py-5 text-white text-center">
          <p>Copyright © 2021 - Meerut Bus Travels Pvt Ltd.</p>
        </div>
      </section>
